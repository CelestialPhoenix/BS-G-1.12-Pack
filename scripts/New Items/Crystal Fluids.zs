...
var NQA = MaterialSystem.getMaterialBuilder().setName("Fluoronaquadraic Acid").setColor(0x777722).build();
var ENQA = MaterialSystem.getMaterialBuilder().setName("Enriched Fluoronaquadraic Acid").setColor(0x777722).build();
var NQ312 = MaterialSystem.getMaterialBuilder().setName("Fluoronaquadraic312 Acid").setColor(0x777722).build();
var NQ314 = MaterialSystem.getMaterialBuilder().setName("Fluoronaquadraic314 Acid").setColor(0x777722).build();
var NQ319 = MaterialSystem.getMaterialBuilder().setName("Fluoronaquadraic319 Acid").setColor(0x777722).build();

#Petrochem
var lubricant = MaterialSystem.getMaterialBuilder().setName("Lubricant").setColor(0xFFFF00).build();

var fluid_list = [antimatter, refined_antimatter, luck, magnetic, toxic, UF6, UF6235, UF6238, NQA, ENQA, NQ312, NQ314, NQ319, lubricant] as Material[];
