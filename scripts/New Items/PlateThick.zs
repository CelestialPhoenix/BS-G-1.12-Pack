...
var PlateThickStainless = VanillaFactory.createItem("platethickstainless");
PlateThickStainless.register();
...
var PlateThickHssg = VanillaFactory.createItem("platethickhssg");
PlateThickHssg.register();
