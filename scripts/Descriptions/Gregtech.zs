...
#Multi-Smelter
mods.jei.JEI.addDescription([<gregtech:machine:516>],"A furnace on steroids! The Multi Smelter is used for smelting multiple items at once.", "Different tiers of coils provide a speed boost and energy efficiency gain.", "16 is the base value of items smelted per operation, and can be multiplied by using a higher tier of coil.");
