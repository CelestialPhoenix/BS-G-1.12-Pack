...
#-LP Steam Machines-
mods.jei.JEI.addDescription([<meta_tile_entity:gregtech:steam_extractor_bronze>, <meta_tile_entity:gregtech:steam_macerator_bronze>, <meta_tile_entity:gregtech:steam_compressor_bronze>, <meta_tile_entity:gregtech:steam_hammer_bronze>, <meta_tile_entity:gregtech:steam_furnace_bronze>, <meta_tile_entity:gregtech:steam_alloy_smelter_bronze>],"Low pressure steam driven machinery. Will process recipes equivilant to 2Eu/t.", "You must provide sufficient steam to complete the recipe, otherwise the machine will stall and need to start over.");
