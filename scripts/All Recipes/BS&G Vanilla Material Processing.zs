...
furnace.addRecipe(<ore:ingotCoblatBrass>.firstItem*9, <ore:blockCobaltBrass>);
...
furnace.addRecipe(<ore:ingotStyreneBudieneRubber>.firstItem*9, <ore:blockStyreneBudieneRubber>);
