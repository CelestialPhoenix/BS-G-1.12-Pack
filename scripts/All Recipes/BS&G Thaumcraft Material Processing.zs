...
mods.thaumcraft.Crucible.registerRecipe("decayEcobronium322", "METALLURGY@1", <ore:ingotPuyrium322>.firstItem, <ore:ingotEcobronium322>.firstItem [<aspect:perditio>*46, <aspect:permutatio>*46]);
...
mods.thaumcraft.Crucible.registerRecipe("decayEcobronium324", "METALLURGY@1", <ore:ingotPuyrium324>.firstItem, <ore:ingotEcobronium324>.firstItem [<aspect:perditio>*56, <aspect:permutatio>*56]);
...
mods.thaumcraft.Crucible.registerRecipe("decayPuyrium319", "METALLURGY@1", <ore:ingotTungsten>.firstItem, <ore:ingotPuyrium319>.firstItem [<aspect:perditio>*78, <aspect:permutatio>*78]);
mods.thaumcraft.Crucible.registerRecipe("decayPuyrium320", "METALLURGY@1", <ore:ingotBerkelium247>.firstItem, <ore:ingotPuyrium320>.firstItem [<aspect:perditio>*57, <aspect:permutatio>*57]);
mods.thaumcraft.Crucible.registerRecipe("decayPuyrium321", "METALLURGY@1", <ore:ingotVyrallium321>.firstItem, <ore:ingotPuyrium321>.firstItem [<aspect:perditio>*68, <aspect:permutatio>*68]);
mods.thaumcraft.Crucible.registerRecipe("decayPuyrium322", "METALLURGY@1", <ore:ingotPlatinum>.firstItem, <ore:ingotPuyrium322>.firstItem [<aspect:perditio>*76, <aspect:permutatio>*76]);
mods.thaumcraft.Crucible.registerRecipe("decayPuyrium323", "METALLURGY@1", <ore:ingotBerkelium248>.firstItem, <ore:ingotPuyrium323>.firstItem [<aspect:perditio>*58, <aspect:permutatio>*58]);
mods.thaumcraft.Crucible.registerRecipe("decayPuyrium324", "METALLURGY@1", <ore:ingotTantalum>.firstItem, <ore:ingotPuyrium324>.firstItem [<aspect:perditio>*80, <aspect:permutatio>*80]);
mods.thaumcraft.Crucible.registerRecipe("decayPuyrium325", "METALLURGY@1", <ore:ingotIridium>.firstItem, <ore:ingotPuyrium325>.firstItem [<aspect:perditio>*77, <aspect:permutatio>*77]);
mods.thaumcraft.Crucible.registerRecipe("decayPuyrium326", "METALLURGY@1", <ore:ingotGold>.firstItem, <ore:ingotPuyrium326>.firstItem [<aspect:perditio>*76, <aspect:permutatio>*76]);
mods.thaumcraft.Crucible.registerRecipe("decayPuyrium327", "METALLURGY@1", <ore:ingotVyrallium327>.firstItem, <ore:ingotPuyrium327>.firstItem [<aspect:perditio>*58, <aspect:permutatio>*58]);
mods.thaumcraft.Crucible.registerRecipe("decayPuyrium328", "METALLURGY@1", <ore:ingotCalifornium252>.firstItem, <ore:ingotPuyrium328>.firstItem [<aspect:perditio>*58, <aspect:permutatio>*58]);
