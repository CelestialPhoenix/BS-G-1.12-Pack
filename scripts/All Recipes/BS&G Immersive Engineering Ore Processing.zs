...
mods.immersiveengineering.ArcFurnace.addRecipe(<ore:dustOsmium>.firstItem*5, <ore:oreOsmium>, <ore:itemSlagRich>.firstItem*1, 2000, 2048);
...
#Mineral Ores
mods.immersiveengineering.ArcFurnace.addRecipe(<ore:nuggetIron>.firstItem*20, <ore:oreAlmandine>, <ore:itemSlagRich>.firstItem*5, 2000, 2048);
...
mods.immersiveengineering.ArcFurnace.addRecipe(<ore:nuggetCalcium>.firstItem*16, <ore:oreGrossular>, <ore:itemSlagRich>.firstItem*5, 2000, 2048);
mods.immersiveengineering.ArcFurnace.addRecipe(<ore:dustTinyRutile>.firstItem*42, <ore:oreIlmenite>, <ore:itemSlagRich>.firstItem*4, 2000, 2048);
...
mods.immersiveengineering.ArcFurnace.addRecipe(<ore:nuggetAluminium>.firstItem*37, <ore:oreBauxite>, <ore:itemSlagRich>.firstItem*3, 2000, 2048);
...
mods.immersiveengineering.ArcFurnace.addRecipe(<ore:nuggetMagnesium>.firstItem*18, <ore:orePyrope>, <ore:itemSlagRich>.firstItem*4, 2000, 2048);
mods.immersiveengineering.ArcFurnace.addRecipe(<ore:itemSlagRich>.firstItem*2, <ore:oreRockSalt>, <ore:itemSlagRich>.firstItem*5, 2000, 2048);
...
mods.immersiveengineering.ArcFurnace.addRecipe(<ore:itemSlagRich>.firstItem*2, <ore:oreSalt>, <ore:itemSlagRich>.firstItem*5, 2000, 2048);
mods.immersiveengineering.ArcFurnace.addRecipe(<ore:itemSlagRich>.firstItem*2, <ore:oreSaltpeter>, <ore:itemSlagRich>.firstItem*5, 2000, 2048);
...
mods.immersiveengineering.ArcFurnace.addRecipe(<ore:nuggetChrome>.firstItem*10, <ore:oreRedstone>, <ore:itemSlagRich>.firstItem*6, 2000, 2048);
...
mods.immersiveengineering.ArcFurnace.addRecipe(<ore:ingotCalcium>.firstItem*33, <ore:oreApatite>, <ore:itemSlagRich>.firstItem*3, 2000, 2048);
mods.immersiveengineering.ArcFurnace.addRecipe(<ore:nuggetCalcium>.firstItem*49, <ore:orePhosphor>, <ore:itemSlagRich>.firstItem*3, 2000, 2048);
mods.immersiveengineering.ArcFurnace.addRecipe(<ore:nuggetManganese>.firstItem*6, <ore:oreGarnetRed>, <ore:itemSlagRich>.firstItem*6, 2000, 2048);
mods.immersiveengineering.ArcFurnace.addRecipe(<ore:nuggetChrome>.firstItem*4, <ore:oreGarnetYellow>, <ore:itemSlagRich>.firstItem*6, 2000, 2048);
...
mods.immersiveengineering.ArcFurnace.addRecipe(<ore:nuggetNeodymium>.firstItem*3, <ore:oreMonazite>, <ore:itemSlagRich>.firstItem*6, 2000, 2048);
...
mods.immersiveengineering.ArcFurnace.addRecipe(<ore:dustTinyRutile>.firstItem*25, <ore:orePsudobrookite>, <ore:itemSlagRich>.firstItem*5, 2000, 2048);
...
mods.immersiveengineering.ArcFurnace.addRecipe(<ore:ingotBeryllium>.firstItem*1, <ore:oreGadolinite>, <ore:itemSlagRich>.firstItem*5, 2000, 2048);
...
mods.immersiveengineering.ArcFurnace.addRecipe(<ore:dustTinyNaquadria>.firstItem*6, <ore:oreNaquarrite>, <ore:itemSlagRich>.firstItem*5, 2000, 2048);
mods.immersiveengineering.ArcFurnace.addRecipe(<ore:nuggetIron>.firstItem*52, <ore:oreXifengite>, <ore:itemSlagRich>.firstItem*2, 2000, 2048);
mods.immersiveengineering.ArcFurnace.addRecipe(<ore:nuggetLead>.firstItem*23, <ore:oreXilingolite>, <ore:itemSlagRich>.firstItem*5, 2000, 2048);
mods.immersiveengineering.ArcFurnace.addRecipe(<ore:nuggetBismuth>.firstItem*11, <ore:oreBerryite>, <ore:itemSlagRich>.firstItem*5, 2000, 2048);
...
mods.immersiveengineering.ArcFurnace.addRecipe(<ore:ingotZinc>.firstItem*2, <ore:oreGoslarite>, <ore:itemSlagRich>.firstItem*5, 2000, 2048);
mods.immersiveengineering.ArcFurnace.addRecipe(<ore:nuggetSilver>.firstItem*44, <ore:oreUytenbogaardtite>, <ore:itemSlagRich>.firstItem*3, 2000, 2048);
...
mods.immersiveengineering.ArcFurnace.addRecipe(<ore:nuggetPalladium>.firstItem*33, <ore:oreSkaergaarditeS>, <ore:itemSlagRich>.firstItem*4, 2000, 2048);
...
mods.immersiveengineering.ArcFurnace.addRecipe(<ore:nuggetPlatinum>.firstItem*33, <ore:oreSheldite>, <ore:itemSlagRich>.firstItem*3, 2000, 2048);
...
mods.immersiveengineering.ArcFurnace.addRecipe(<ore:dustTinyNaquadah>.firstItem*13, <ore:oreNaquoxiite>, <ore:itemSlagRich>.firstItem*4, 2000, 2048);
mods.immersiveengineering.ArcFurnace.addRecipe(<ore:dustTinyNaquadria>.firstItem*13, <ore:oreNaquothxa>, <ore:itemSlagRich>.firstItem*4, 2000, 2048);
