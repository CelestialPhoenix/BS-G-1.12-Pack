...
centrifuge
    ...
    .outputs(<ore:dustNaquadria>.firstItem, <ore:dustSmallCalifornium252>.firstItem*3, <ore:dustSmallThorium>.firstItem*1)
    .duration(200)
    .EUt(800)
    .buildAndRegister();
...
centrifuge
    .recipeBuilder()
	.inputs(<ore:dustNaquforniaThaum>)
    .outputs(<ore:dustTinyNaquadahEnriched>.firstItem, <ore:dustTinyPlutonium241>.firstItem*2, <ore:dustTinyCalifornium252>.firstItem*7, <ore:dustTinyThorium>.firstItem*2)
    .duration(200)
    .EUt(800)
    .buildAndRegister();
