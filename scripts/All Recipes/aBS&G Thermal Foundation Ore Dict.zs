...
<ore:blockSteel>.remove(<thermalfoundation:storage_alloy:0>);
...
<ore:blockSignalum>.remove(<thermalfoundation:storage_alloy:5>);
<ore:blockLumium>.remove(<thermalfoundation:storage_alloy:6>);
<ore:blockEnderium>.remove(<thermalfoundation:storage_alloy:7>);
...
<ore:dustMagicCatalyst>.add(<thermalfoundation:material:1028>);
#Gears
...
<ore:gearEmerald>.remove(<thermalfoundation:material:27>);
...
<ore:gearAluminum>.remove(<thermalfoundation:material:260>);
...
<ore:gearConstantan>.remove(<thermalfoundation:material:292>);
...
#Machine parts
<ore:partSawblade>.add(<thermalfoundation:material:657>);
<ore:servoRedstone>.add(<thermalfoundation:material:512>);

#Nuggets
#<ore:nugget>.add(<thermalfoundation:material:>);
