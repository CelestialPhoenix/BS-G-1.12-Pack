...
#---Conveyor Module---
mods.jei.JEI.addDescription([<metaitem:conveyor.module.lv>, <metaitem:conveyor.module.mv>, <metaitem:conveyor.module.hv>, <metaitem:conveyor.module.ev>, <metaitem:conveyor.module.iv>, <metaitem:conveyor.module.luv>, <metaitem:conveyor.module.zpm>, <metaitem:conveyor.module.uv>],"A simple mechanism of two motors and a rubber belt.
This can be attached to a machine (right click) and configured (right click with a screwdriver) to continuously move items from A to B. An Item Filter or Ore Dictionary Filter can also be fitted if required.");

#---Motor.---
mods.jei.JEI.addDescription([<metaitem:electric.motor.lv>, <metaitem:electric.motor.mv>, <metaitem:electric.motor.hv>, <metaitem:electric.motor.ev>, <metaitem:electric.motor.iv>, <metaitem:electric.motor.luv>, <metaitem:electric.motor.zpm>, <metaitem:electric.motor.uv>],"It rotates.
It rotates stuff.
It rotates stuff attached to stuff.
